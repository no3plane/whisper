// oxlint-disable react/no-unstable-nested-components -- react-markdown 的组件映射需要闭包访问当前文档的 block 与资源表。
...
export function MarkdownDocument({ markdown, blocks, resources }: Props) {
  const byStart = new Map(blocks.map((block) => [block.sourceStart, block]));
